...
Recent advances—Self-RAG's self-verification \citep{asai2023selfrag}, 
...
\begin{itemize}
  ...
  \citep{shao2023iterretgen,asai2023selfrag}—the Courtroom store is
...
\(I(\theta;X)\le I\) under the uniform prior on an $M$-point
...
\begin{equation}\label{eq:ErrLower-new}
  \boxed{\;
     \Err_{\mathrm{bar}}
       ...
       \frac{\delta\,T}{4}\;
       \kappa_{\!*}\;
       \Bigl(1-\tfrac{I+\log 2}{\log M}\Bigr),
     \quad
     \kappa_{\!*}:=\E[\kappa\mid\Err>\tfrac12\delta\kappa T]
  }
  \, .
\end{equation}
\end{lemma}
...
Define
\[
  \gamma:=\frac12\Bigl(1-\tfrac{I+\log 2}{\log M}\Bigr)\in(0,\tfrac12].
\]
Then
...
\begin{aligned}
  \Err_{\mathrm{bar}}
    ...
    &=\frac{\delta T}{2}\,
      \kappa_{\!*}\;
      \Pr(\mathcal E) \\[2pt]
    &\ge \frac{\delta T}{4}\,\kappa_{\!*}\, \Bigl(1-\tfrac{I+\log 2}{\log M}\Bigr)\;.
\end{aligned}
\]
