...
\begin{abstract}
  ...
  A 100-query toy stream illustrates how the ledger is logged\footnote{Baseline script will appear at \url{https://github.com/johnrepsys/courtroom-model-lean} with v2.}; no attempt is made here to optimise the validator.
