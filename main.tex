...
Choosing the 0–1 loss $L(M,X)=\mathbf 1\{\hat M(X)\neq M\}$
...
\medskip
\noindent
To obtain a bound on label error we apply the same proposition to
the indicator
\[
...
\item
  Re-apply Proposition 3 to
  $L^\star = \mathbf 1\{\Err>\Delta_{\mathrm{Err}}\}$
  with threshold $\Delta=\tfrac12$.
